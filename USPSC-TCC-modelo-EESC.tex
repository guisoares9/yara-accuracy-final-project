...
% Handle accidental zero-width characters pasted from editors
...
% subfigure is obsolete and conflicts with caption; use subcaption instead
\usepackage{caption}
\usepackage{subcaption}

% fig Tailarach apparatus
\usepackage{graphicx}
\usepackage{amsmath}
