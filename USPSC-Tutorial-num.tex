...
%Para Teses, Dissertações, TCCs e outros trabalhos acadêmicos, no arquivo USPSC-Modelo.tex e USPSC-TCC-modelo.tex, utilizar o comando \include{USPSC-TA-PreTextual/USPSC-Errata}
...
% INDICE REMISSIVO
%--------------------------------------------------------------------
%\include{USPSC-Tutorial/USPSC-IndicesRemissivos}
\phantompart
\printindex
%---------------------------------------------------------------------
